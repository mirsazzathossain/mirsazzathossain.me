...
export default function MainView(): JSX.Element {
  ...
  return (
    <div className="lg:flex lg:h-full lg:flex-col">
      ...
      <header className="relative flex items-center justify-between py-4 px-6 lg:flex-none border-b border-zinc-100 dark:border-zinc-700/40 bg-zinc-50 dark:bg-zinc-800/90 shadow-sm ring-1 ring-zinc-100 dark:ring-zinc-700/40 ring-opacity-5 rounded-t-sm">
        ...
        <div className="flex items-center">
          ...
          <div className="flex items-center rounded-md shadow-xs md:items-stretch">
            <button
              type="button"
