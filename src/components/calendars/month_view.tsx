...
export default function MonthView({
  ...
  return (
    <>
      <div className="shadow-sm ring-1 ring-zinc-100 dark:ring-zinc-700/40 ring-opacity-5 lg:flex lg:flex-auto lg:flex-col bg-zinc-100 dark:bg-zinc-700/40 z-10 relative rounded-b-sm">
        {/* Weekdays start */}
      ...
      {(selectedDay as any)?.events.length > 0 && (
        <div className="py-10 lg:hidden">
          <ol className="divide-y divide-zinc-100 dark:divide-zinc-700/40 overflow-hidden rounded-lg bg-inherent text-sm shadow-sm ring-1 ring-zinc-100 dark:ring-zinc-700/40 ring-opacity-5">
