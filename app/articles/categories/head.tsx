export default function Head(): JSX.Element {
  return (
    <>
      <title>Article Categories - Mir Sazzat Hossain</title>
      ...
      <meta
        name="description"
        content="This page contains all the categories of articles available on this website."
      />

      <meta
        property="og:title"
        content="Article Categories - Mir Sazzat Hossain"
      />
      <meta
